namespace BetterAmazon.Scrapers
{
    ...
    public class VideoGamesScraper
    {
        private const string baseUrl = "https://www.amazon.co.uk/";
        private const string url1 = "https://www.amazon.co.uk/s?i=videogames&bbn=300703&rh=n%3A20862651031&s=review-rank&page=1&brr=1&pd_rd_r=efe72076-e7aa-4863-afb1-55f4580d6582&pd_rd_w=dd668&pd_rd_wg=8MmcF&qid=1640095933&rd=1&ref=sr_pg_1";
        private const string url2 = "https://www.amazon.co.uk/s?i=videogames&bbn=300703&rh=n%3A20862651031&s=review-rank&page=2&brr=1&pd_rd_r=efe72076-e7aa-4863-afb1-55f4580d6582&pd_rd_w=dd668&pd_rd_wg=8MmcF&qid=1640095933&rd=1&ref=sr_pg_2";
        private const string url3 = "https://www.amazon.co.uk/s?i=videogames&bbn=300703&rh=n%3A20862651031&s=review-rank&page=3&brr=1&pd_rd_r=efe72076-e7aa-4863-afb1-55f4580d6582&pd_rd_w=dd668&pd_rd_wg=8MmcF&qid=1640095933&rd=1&ref=sr_pg_3";
        private const string url4 = "https://www.amazon.co.uk/s?i=videogames&bbn=300703&rh=n%3A20862651031&s=review-rank&page=4&brr=1&pd_rd_r=efe72076-e7aa-4863-afb1-55f4580d6582&pd_rd_w=dd668&pd_rd_wg=8MmcF&qid=1640095933&rd=1&ref=sr_pg_4";
        private const string url5 = "https://www.amazon.co.uk/s?i=videogames&bbn=300703&rh=n%3A20862651031&s=review-rank&page=5&brr=1&pd_rd_r=efe72076-e7aa-4863-afb1-55f4580d6582&pd_rd_w=dd668&pd_rd_wg=8MmcF&qid=1640095933&rd=1&ref=sr_pg_5";
        private const string url6 = "https://www.amazon.co.uk/s?i=videogames&bbn=300703&rh=n%3A20862651031&s=review-rank&page=6&brr=1&pd_rd_r=efe72076-e7aa-4863-afb1-55f4580d6582&pd_rd_w=dd668&pd_rd_wg=8MmcF&qid=1640095933&rd=1&ref=sr_pg_6";

        public static async Task<List<VideoGameDto>> GetData()
        {
            List<VideoGameDto> details = new List<VideoGameDto>();
            ...
            foreach (var url in scrapingUrls)
            {
                ...
                foreach (var book in booksList)
                {
                    ...
                    VideoGameDto bookModel = new VideoGameDto();
